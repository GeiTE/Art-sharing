$(function(){
    ...
    if(works_show_works_id){
        ...
        if($.cookie('user_email')){ //是否有用户登录
            ...
            console.log("../../images/user_head_portrait/"+localStorage['user_head_portrait']);
            $("#pinlun>div>div>img").attr("src","../../images/user_head_portrait/"+localStorage['user_head_portrait']);
        }else{
            //禁止数据评论
